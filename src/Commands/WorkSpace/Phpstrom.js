...
class Phpstrom extends BaseCommand{
  async exec() {
    ...
    const outputConfigFilePath = this.resolve('/tmp/phpstorm.desktop')
    this.writeFileSync(outputConfigFilePath, this._getDesktopConfig(), 'utf8')
